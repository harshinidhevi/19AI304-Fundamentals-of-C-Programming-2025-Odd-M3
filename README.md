...
int main() { int num, rem, binary[32], i = 0, k;
...
```
# Output:
<img width="575" height="85" alt="image" src="https://github.com/user-attachments/assets/a6126bda-e471-4ee8-b506-c5b2ea1965ef" />
...
```
# Output:
<img width="700" height="264" alt="image" src="https://github.com/user-attachments/assets/2b4d32e8-88a6-4024-b1fb-3cd61b0d6f18" />
...
scanf("%[^\n]s", s); printf("Enter thre string:%s\n",s);
...
```
# Output:
<img width="257" height="113" alt="image" src="https://github.com/user-attachments/assets/56c0c657-e0fa-4bd9-acf5-dd7c499abeff" />
...
```
# Output:
<img width="220" height="248" alt="image" src="https://github.com/user-attachments/assets/1aa28716-1903-448d-b8f2-6e3b50b36843" />
...
```
# Output:
<img width="396" height="147" alt="image" src="https://github.com/user-attachments/assets/a7609af7-f4f1-4e41-b101-c06265548b83" />
